...
const Footer = (props) => {
    ...
    return (
        <NavContainer>
            ...
            <NavBar>
                <ButtonBase onClick={() => goToFeed(history)}>{props.feed ? <img src={homeLaranja} /> : <img src={home} />} </ButtonBase>
                <ButtonBase onClick={() => goToShopCart(history)}>{props.ShopCart ? <img src={cartLaranja} /> : <img src={cart} />}</ButtonBase>
                <ButtonBase onClick={() => goToProfile(history)}>{props.profile ? <img src={avatarLaranja} /> : <img src={avatar} />}</ButtonBase>
            </NavBar>
        </NavContainer>
    )
}
